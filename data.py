...
class SalObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize):
        ...
        self.images = []
        self.gts = []
        lines = os.listdir(gt_root)
        for line in lines:
            self.images.append(os.path.join(image_root, line[:-4] + '.png'))
            self.gts.append(os.path.join(gt_root, line))
...
class test_dataset:
    ...
    def load_data(self):
        ...
        return image, gt, name, np.array(image_for_post), image1
